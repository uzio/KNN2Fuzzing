  ...
  <div class="vuls-container">
    <el-tabs type="border-card" v-model="currentTab">
      ...
      <el-tab-pane label="漏洞信息" name="vuls">
        <vuls-table :vuls="this.$store.state.vul.vuls"/>
...
<script>
import { getVuls, uploadFile, onlineUpdate, updateState } from "./api";
...
export default {
  ...
  computed: {
    total() {
      return this.$store.state.vul.total
    },
    currentPage() {
      return this.$store.state.vul.page;
    }
  },
  beforeDestroy() {
    if (this.updateTimer) {
  ...
  methods: {
    handlePageChange(page) {
      this.$store.commit("SET_VULS_PAGINATION", {page})
      this.$store.dispatch("reloadVuls");
    },
    handleFileUpload(e) {
