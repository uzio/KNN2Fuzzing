...
INFO = {
    'title': 'CIP协议设置不同类/实体的值',
    'des':  '通过Ethernet/IP的connect manager请求来设置目标PLC的某一些类的值路径',
    'id':   '1',
    'type': '1',
    'creator': 'shaoshuai',
...
def fuzz(params):
    ...
    cip_pkt = CIP(service=0x4, path=path) / scapy_all.Raw(load=struct.pack('<HH', RandShort(), RandShort()))
