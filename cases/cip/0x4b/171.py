...
INFO = {
    'title': 'CIP协议获取具体类下模糊化实体值',
    'des':  '通过Ethernet/IP的connect manager请求来获取目标PLC的在某一具体类下模糊化所有的实体的值',
    'id':   '1',
    'type': '1',
    'creator': 'shaoshuai',
...
def fuzz(params):
    cip_pkt = CIP(service=0x4b, path=CIP_Path.make(class_id=0, instance_id=RandShort()))
