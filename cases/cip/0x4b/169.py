...
INFO = {
    'title': 'CIP协议获取某一类下所有的实体值',
    'des':  '通过Ethernet/IP的connect manager请求来获取目标PLC的在某一类下所以的实体的值',
    'id':   '1',
    'type': '1',
    'creator': 'shaoshuai',
...
def fuzz(params):
    cip_pkt = CIP(service=0x4b, path=CIP_Path.make(class_id=RandShort(), instance_id=RandShort()))
