...
INFO = {
    'title': 'CIP协议获取多种类/实体的值',
    'des':  '通过Ethernet/IP的connect manager请求来获取目标PLC的不同数量类的值路径',
    'id':   '1',
    'type': '1',
    'creator': 'shaoshuai',
...
def fuzz(params):
    ...
    cip_pkt = CIP(service=0x0e, path=path) / CIP_ReqGetAttributeList(attrs=[RandByte(), RandByte(), RandByte()])
