...
INFO = {
    'title': 'CIP协议forward close请求报文模糊',
    'des':  '通过Ethernet/IP的request/response来发送CIP forward close请求',
    'id':   '1',
    'type': '1',
    'creator': 'shaoshuai',
...
def fuzz(params):
    cip_pkt = CIP(service=0x4e, path=CIP_Path(wordsize=2, path=RandString(2)))
