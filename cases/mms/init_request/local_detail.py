...
INFO = {
    'title': 'IEC/ISO 61850 MMS协议 Init Request报文Local Detail Calling字段',
    'des':  '在MMS协议中Init Request报文Local Detail Calling字段控制local user',
    'id':   '1',
    'type': '1',
    'creator': 'shaoshuai',
...
def fuzz(params):
    ...
    mms_initiate_request = MMSInitiateRequestPdu(localDetailCalling=RandInt(),
