...
INFO = {
    'title': 'IEC/ISO 61850 MMS协议 Init Request类型报文Proposed Max Serve Outstanding Calling字段',
    'des':  '在MMS协议中Init Request报文的最大建议调用字段',
    'id':   '1',
    'type': '1',
    'creator': 'shaoshuai',
...
def fuzz(params):
    ...
    mms_initiate_request = MMSInitiateRequestPdu(localDetailCalling=32000,
                                                 proposedMaxServOutstandingCalling=RandInt(),
