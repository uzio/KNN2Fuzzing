...
INFO = {
    'title': 'IEC/ISO 61850 MMS协议 Init Request类型报文Proposed Max Serve Outstanded Calling字段',
    'des':  '在MMS协议中Init Request报文的最大建议已调用字段',
    'id':   '1',
    'type': '1',
    'creator': 'shaoshuai',
...
def fuzz(params):
    ...
    mms_initiate_request = MMSInitiateRequestPdu(localDetailCalling=32000,
                                                 ...
                                                 proposedMaxServOutstandingCalled=RandInt(),
