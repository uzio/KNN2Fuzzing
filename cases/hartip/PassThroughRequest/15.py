...
INFO = {
    'title':'hart_IP Pass Through request时，模糊 Version',
    'des':  'hart_IP Pass Through request时，模糊 Version',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = hart_IP_header(Version=RandByte(),MessageID=0x03,MessageLength=0x0011)/hart_IP_PassBody()
