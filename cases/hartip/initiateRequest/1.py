...
INFO = {
    'title':'hart_IP initiate request时，模糊 MessageType',
    'des':  'hart_IP initiate request时，模糊 MessageType',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = hart_IP_header(MessageType=RandByte())/hart_IP_Body()
    template = Template(name='hart_IP initiate request时，模糊 MessageType', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
