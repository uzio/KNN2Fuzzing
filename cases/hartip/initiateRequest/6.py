...
INFO = {
    'title':'hart_IP initiate request时，模糊 Status',
    'des':  'hart_IP initiate request时，模糊 Status',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = hart_IP_header(Status=RandByte())/hart_IP_Body()
    template = Template(name='hart_IP initiate request时，模糊 Status', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
