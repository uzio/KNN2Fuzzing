...
INFO = {
    'title':'hart_IP initiate request时，模糊 MessageLength',
    'des':  'hart_IP initiate request时，模糊 MessageLength',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = hart_IP_header(MessageLength=RandShort())/hart_IP_Body()
    template = Template(name='hart_IP initiate request时，模糊 MessageLength', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
