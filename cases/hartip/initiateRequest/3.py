...
INFO = {
    'title':'hart_IP initiate request时，模糊 hostType',
    'des':  'hart_IP initiate request时，模糊 hostType',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = hart_IP_header()/hart_IP_Body(hostType=RandByte())
    template = Template(name='hart_IP initiate request时，模糊 hostType', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
