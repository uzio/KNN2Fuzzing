...
INFO = {
    'title':'hart_IP initiate request时，模糊 Version',
    'des':  'hart_IP initiate request时，模糊 Version',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = hart_IP_header(Version=RandByte())/hart_IP_Body()
    template = Template(name='hart_IP initiate request时，模糊 Version', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
