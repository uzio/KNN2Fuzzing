...
INFO = {
    'title':'Profinet PTCP  模糊 Padding2',
    'des':  'Profinet PTCP  模糊 Padding2',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ProfinetAcyclicRealTime(FrameID=0xff40)/ProfinetPTCP(Padding2=RandShort())
    template = Template(name='Profinet PTCP  模糊 Padding2', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
