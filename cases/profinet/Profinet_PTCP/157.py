...
INFO = {
    'title':'Profinet PTCP  模糊 Padding',
    'des':  'Profinet PTCP  模糊 Padding',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ProfinetAcyclicRealTime(FrameID=0xff40)/ProfinetPTCP(Padding=RandInt()*RandInt()*RandInt())
    template = Template(name='Profinet PTCP  模糊 Padding', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
