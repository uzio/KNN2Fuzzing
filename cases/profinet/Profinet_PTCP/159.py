...
INFO = {
    'title':'Profinet PTCP  模糊 SequenceID',
    'des':  'Profinet PTCP  模糊 SequenceID',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ProfinetAcyclicRealTime(FrameID=0xff40)/ProfinetPTCP(SequenceID=RandShort())
    template = Template(name='Profinet PTCP  模糊 SequenceID', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
