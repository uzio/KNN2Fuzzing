...
INFO = {
    'title':'Profinet PTCP  模糊 Delay1ns',
    'des':  'Profinet PTCP  模糊 Delay1ns',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ProfinetAcyclicRealTime(FrameID=0xff40)/ProfinetPTCP(Delay1ns=RandInt())
    template = Template(name='Profinet PTCP  模糊 Delay1ns', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
