...
INFO = {
    'title':'Profinet PTCP  模糊 PortMACAddress',
    'des':  'Profinet PTCP  模糊 PortMACAddress',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ProfinetAcyclicRealTime(FrameID=0xff40)/ProfinetPTCP(PortMACAddress=RandInt()*RandShort())
    template = Template(name='Profinet PTCP  模糊 TLVHeader', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
