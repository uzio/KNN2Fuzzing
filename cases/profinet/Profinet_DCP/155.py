...
INFO = {
    'title':'Profinet DCP 模糊 Xid',
    'des':  'Profinet DCP 模糊 Xid',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ProfinetAcyclicRealTime(FrameID=0xfefe)/DCPIdentityRequest(Xid=RandInt())
    template = Template(name='Profinet DCP 模糊 Xid', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
