...
INFO = {
    'title':'Profinet DCP 模糊 Suboption',
    'des':  'Profinet DCP 模糊 Suboption',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ProfinetAcyclicRealTime(FrameID=0xfefe)/DCPIdentityRequest(Suboption=RandByte())
    template = Template(name='Profinet DCP 模糊 Suboption', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
