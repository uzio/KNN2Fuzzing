...
INFO = {
    'title':'Profinet DCP 模糊 ServiceType',
    'des':  'Profinet DCP 模糊 ServiceType',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ProfinetAcyclicRealTime(FrameID=0xfefe)/DCPIdentityRequest(ServiceType=RandByte())
    template = Template(name='Profinet DCP 模糊 ServiceType', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
