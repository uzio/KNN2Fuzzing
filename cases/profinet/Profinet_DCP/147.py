...
INFO = {
    'title':'Profinet DCP 模糊 Reserved',
    'des':  'Profinet DCP 模糊 Reserved',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ProfinetAcyclicRealTime(FrameID=0xfefe)/DCPIdentityRequest(Reserved=RandShort())
    template = Template(name='Profinet DCP 模糊 Reserved', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
