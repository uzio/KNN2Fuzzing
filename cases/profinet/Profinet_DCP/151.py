...
INFO = {
    'title':'Profinet DCP 模糊 Padding',
    'des':  'Profinet DCP 模糊 Padding',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ProfinetAcyclicRealTime(FrameID=0xfefe)/DCPIdentityRequest(Padding=RandByte())
    template = Template(name='Profinet DCP 模糊 Padding', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
