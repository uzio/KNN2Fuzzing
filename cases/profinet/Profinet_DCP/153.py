...
INFO = {
    'title':'Profinet DCP 模糊 Option',
    'des':  'Profinet DCP 模糊 Option',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ProfinetAcyclicRealTime(FrameID=0xfefe)/DCPIdentityRequest(Option=RandByte())
    template = Template(name='Profinet DCP 模糊 Option', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
