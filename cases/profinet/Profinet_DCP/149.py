...
INFO = {
    'title':'Profinet DCP 模糊 DCPDataLength',
    'des':  'Profinet DCP 模糊 DCPDataLength',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ProfinetAcyclicRealTime(FrameID=0xfefe)/DCPIdentityRequest(DCPDataLength=RandShort())
    template = Template(name='Profinet DCP 模糊 DCPDataLength', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
