...
INFO = {
    'title':'Profinet DCP 模糊 DCPBlockLength',
    'des':  'Profinet DCP 模糊 DCPBlockLength',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ProfinetAcyclicRealTime(FrameID=0xfefe)/DCPIdentityRequest()
    template = Template(name='Profinet DCP 模糊 DCPBlockLength', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
