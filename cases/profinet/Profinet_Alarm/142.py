...
INFO = {
    'title':'Profinet IO Alarm 模糊 ErrorDecode',
    'des':  'Profinet IO Alarm 模糊 ErrorDecode',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ProfinetAcyclicRealTime(FrameID=0xfe01)/ProfinetAlarmFrame(ErrorDecode=RandByte())
    template = Template(name='Profinet IO Alarm 模糊 ErrorDecode', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
