...
INFO = {
    'title':'Profinet IO Alarm 模糊 AlarmSrcEndpoint',
    'des':  'Profinet IO Alarm 模糊 AlarmSrcEndpoint',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ProfinetAcyclicRealTime(FrameID=0xfe01)/ProfinetAlarmFrame(AlarmSrcEndpoint=RandShort())
    template = Template(name='Profinet IO Alarm 模糊 AlarmSrcEndpoint', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
