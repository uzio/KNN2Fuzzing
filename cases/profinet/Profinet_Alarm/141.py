...
INFO = {
    'title':'Profinet IO Alarm 模糊 ErrorCode',
    'des':  'Profinet IO Alarm 模糊 ErrorCode',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ProfinetAcyclicRealTime(FrameID=0xfe01)/ProfinetAlarmFrame(ErrorCode=RandByte())
    template = Template(name='Profinet IO Alarm 模糊 ErrorCode', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
