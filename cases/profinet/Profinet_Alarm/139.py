...
INFO = {
    'title':'Profinet IO Alarm 模糊 AlarmDstEndpoint',
    'des':  'Profinet IO Alarm 模糊 AlarmDstEndpoint',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ProfinetAcyclicRealTime(FrameID=0xfe01)/ProfinetAlarmFrame(AlarmDstEndpoint=RandShort())
    template = Template(name='Profinet IO Alarm 模糊 AlarmDstEndpoint', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
