...
INFO = {
    'title':'Profinet IO Alarm 模糊 ErrorCode1',
    'des':  'Profinet IO Alarm 模糊 ErrorCode1',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ProfinetAcyclicRealTime(FrameID=0xfe01)/ProfinetAlarmFrame(ErrorCode1=RandByte())
    template = Template(name='Profinet IO Alarm 模糊 ErrorCode1', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
