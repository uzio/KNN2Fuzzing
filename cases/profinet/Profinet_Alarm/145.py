...
INFO = {
    'title':'Profinet IO Alarm 模糊 VarPartLen',
    'des':  'Profinet IO Alarm 模糊 VarPartLen',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ProfinetAcyclicRealTime(FrameID=0xfe01)/ProfinetAlarmFrame(VarPartLen=RandShort())
    template = Template(name='Profinet IO Alarm 模糊 VarPartLen', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
