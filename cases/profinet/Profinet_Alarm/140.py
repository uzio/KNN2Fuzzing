...
INFO = {
    'title':'Profinet IO Alarm 模糊 SendSeqNum',
    'des':  'Profinet IO Alarm 模糊 SendSeqNum',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ProfinetAcyclicRealTime(FrameID=0xfe01)/ProfinetAlarmFrame(SendSeqNum=RandShort())
    template = Template(name='Profinet IO Alarm 模糊 SendSeqNum', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
