...
INFO = {
    'title':'Profinet IO Alarm 模糊 AddFlags',
    'des':  'Profinet IO Alarm 模糊 AddFlags',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ProfinetAcyclicRealTime(FrameID=0xfe01)/ProfinetAlarmFrame(AddFlags=RandByte())
    template = Template(name='Profinet IO Alarm 模糊 AddFlags', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
