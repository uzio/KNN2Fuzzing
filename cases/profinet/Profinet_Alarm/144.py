...
INFO = {
    'title':'Profinet IO Alarm 模糊 AckSeqNum',
    'des':  'Profinet IO Alarm 模糊 AckSeqNum',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ProfinetAcyclicRealTime(FrameID=0xfe01)/ProfinetAlarmFrame(AckSeqNum=RandShort())
    template = Template(name='Profinet IO Alarm 模糊 AckSeqNum', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
