...
INFO = {
    'title': 'IEC/ISO 61850 GOOSE协议goose control block reference字段',
    'des':  'IEC/ISO 61850 GOOSE协议goose control block reference字段',
    'id':   '1',
    'type': '1',
    'creator': 'shaoshuai',
...
def fuzz(params):
    ...
    pdu = GOOSEPDU(pdu_s)
    pdu.gocbRef = VisibleString(str(RandString(10)))
    goose_packet = GOOSE()
