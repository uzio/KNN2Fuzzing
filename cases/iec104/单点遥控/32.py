...
INFO = {
    'title': 'IEC 104 单点遥控，模糊 TypeId',
    'des':   'IEC 104 单点遥控，模糊 TypeId ',
    'id':   '1',
    'type': '1',
    'creator': 'lyp',
...
def fuzz(params):
    ...
    Packet =IEC_Apci_ParameterRsq()/IEC_Asdu_ParameterRsq(TypeId=RandByte())
    templete = Template(name='IEC 104 单点遥控，模糊 TypeId', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
