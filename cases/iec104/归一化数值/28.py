...
INFO = {
    'title': 'IEC 104 设置归一化数值，模糊 Addr',
    'des':   'IEC 104 设置归一化数值，模糊 Addr ',
    'id':   '1',
    'type': '1',
    'creator': 'lyp',
...
def fuzz(params):
    ...
    Packet =IEC_Apci_ParameterRsq()/IEC_Asdu_ParameterRsq(Addr=RandShort())
    templete = Template(name='IEC 104 设置归一化数值，模糊 Addr', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
