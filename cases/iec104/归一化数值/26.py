...
INFO = {
    'title': 'IEC 104 设置归一化数值，模糊 Unknow',
    'des':   'IEC 104 设置归一化数值，模糊 Unknow ',
    'id':   '1',
    'type': '1',
    'creator': 'lyp',
...
def fuzz(params):
    ...
    Packet =IEC_Apci_ParameterRsq()/IEC_Asdu_ParameterRsq(Unknow=RandShort())
    templete = Template(name='IEC 104 设置归一化数值，模糊 Unknow', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
