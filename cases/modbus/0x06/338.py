...
INFO = {
    'title':'写单个寄存器时，value字段的长度延长',
    'des':  'value 字段长度为2个字节，延长到4个字节',
    'id':   '5',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    Packet = ModbusHeaderRequest(func_code=0x06, unit_id=0x01) / WriteSingleRegisterRequest_v1(
        ReferenceNumber=RandShort(),Value=0x0001,ertraField=RandShort())
