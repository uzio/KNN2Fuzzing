...
INFO = {
    'title':'读取设备设备码,模糊MEIType',
    'des':  '读取设备设备码,模糊MEIType',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = ModbusHeaderRequest(func_code=0x2B, unit_id=0x01) / ReadDeviceID(MEIType=RandByte)
    template = Template(name='读取设备设备码,模糊MEIType', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
