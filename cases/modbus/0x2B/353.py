...
INFO = {
    'title':'读取设备设备码,模糊objectID',
    'des':  '读取设备设备码,模糊objectID',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = ModbusHeaderRequest(func_code=0x2B, unit_id=0x01) / ReadDeviceID(objectID=RandByte())
    template = Template(name='读取设备设备码,模糊objectID', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
