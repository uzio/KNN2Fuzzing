...
INFO = {
    'title':'PLC Run,模糊 Source_network_address',
    'des':  'PLC Run,模糊 Source_network_address',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Source_network_address=RandByte(),Command_code=0x0401)
    template = Template(name='PLC Run,模糊 Source_network_address', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
