...
INFO = {
    'title':'Memory Area Read,模糊 Source_node_number',
    'des':  'Memory Area Read,模糊 Source_node_number',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Source_node_number=RandByte())/MemoryReadCommand_Data()
    template = Template(name='Memory Area Read,模糊 Source_node_number', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
