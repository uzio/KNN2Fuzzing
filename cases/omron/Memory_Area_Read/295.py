...
INFO = {
    'title':'Memory Area Read,模糊 Reserved',
    'des':  'Memory Area Read,模糊 Reserved',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Reserved=RandByte())/MemoryReadCommand_Data()
    template = Template(name='Memory Area Read,模糊 Reserved', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
