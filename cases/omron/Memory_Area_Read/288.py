...
INFO = {
    'title':'Memory Area Read,模糊 Source_unit_address',
    'des':  'Memory Area Read,模糊 Source_unit_address',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Source_unit_address=RandByte())/MemoryReadCommand_Data()
    template = Template(name='Memory Area Read,模糊 Source_unit_address', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
