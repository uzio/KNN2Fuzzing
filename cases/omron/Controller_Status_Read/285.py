...
INFO = {
    'title':'Controller Status Read,模糊 Reserved',
    'des':  'Controller Status Read,模糊 Reserved',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Reserved=RandByte(),Command_code=0x0601)
    template = Template(name='Controller Status Read,模糊 Reserved', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
