...
INFO = {
    'title':'Controller Status Read,模糊 Source_node_number',
    'des':  'Controller Status Read,模糊 Source_node_number',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Source_node_number=RandByte(),Command_code=0x0601)
    template = Template(name='Controller Status Read,模糊 Source_node_number', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
