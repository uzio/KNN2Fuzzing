...
INFO = {
    'title':'Controller Status Read,模糊 Service_ID',
    'des':  'Controller Status Read,模糊 Service_ID',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Service_ID=RandByte(),Command_code=0x0601)
    template = Template(name='Controller Status Read,模糊 Service_ID', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
