...
INFO = {
    'title':'Controller Status Read,模糊 Destination_unit_address',
    'des':  'Controller Status Read,模糊 Destination_unit_address',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Destination_unit_address=RandByte(),Command_code=0x0601)
    template = Template(name='Controller Status Read,模糊 Destination_unit_address', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
