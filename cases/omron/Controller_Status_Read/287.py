...
INFO = {
    'title':'Controller Status Read,模糊 Destination_node_address',
    'des':  'Controller Status Read,模糊 Destination_node_address',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Destination_node_address=RandByte(),Command_code=0x0601)
    template = Template(name='Controller Status Read,模糊 Destination_node_address', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
