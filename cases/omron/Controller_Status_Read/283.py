...
INFO = {
    'title':'Controller Status Read,模糊 Gateway_Count',
    'des':  'Controller Status Read,模糊 Gateway_Count',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Gateway_Count=RandByte(),Command_code=0x0601)
    template = Template(name='Controller Status Read,模糊 Gateway_Count', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
