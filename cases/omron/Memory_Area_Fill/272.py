...
INFO = {
    'title':'Memory Area Fill,模糊 Command_Data',
    'des':  'Memory Area Fill,模糊 Command_Data',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Command_code=0x0103)/MemoryWriteCommand_Data(Command_Data=RandInt())
    template = Template(name='Memory Area Fill,模糊 Command_Data', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
