...
INFO = {
    'title':'Memory Area Fill,模糊 Beginning_Address',
    'des':  'Memory Area Fill,模糊 Beginning_Address',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Command_code=0x0103)/MemoryWriteCommand_Data(Beginning_Address=RandByte())
    template = Template(name='Memory Area Fill,模糊 Beginning_Address', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
