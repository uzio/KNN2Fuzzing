...
INFO = {
    'title':'Memory Area Fill,模糊 Number_of_items',
    'des':  'Memory Area Fill,模糊 Number_of_items',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Command_code=0x0103)/MemoryWriteCommand_Data(Number_of_items=RandByte())
    template = Template(name='Memory Area Fill,模糊 Number_of_items', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
