...
INFO = {
    'title':'Memory Area Fill,模糊 Command_code',
    'des':  'Memory Area Fill,模糊 Command_code',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Command_code=RandShort())/MemoryWriteCommand_Data()
    template = Template(name='Memory Area Fill,模糊 Command_code', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
