...
INFO = {
    'title':'Memory Area Fill,模糊 Destination_unit_address',
    'des':  'Memory Area Fill,模糊 Destination_unit_address',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Destination_unit_address=RandByte(),Command_code=0x0103)/MemoryWriteCommand_Data()
    template = Template(name='Memory Area Fill,模糊 Destination_unit_address', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
