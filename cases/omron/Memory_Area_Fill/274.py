...
INFO = {
    'title':'Memory Area Fill,模糊 Memory_Area_Code',
    'des':  'Memory Area Fill,模糊 Memory_Area_Code',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Command_code=0x0103)/MemoryWriteCommand_Data(Memory_Area_Code=RandByte())
    template = Template(name='Memory Area Fill,模糊 Memory_Area_Code', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
