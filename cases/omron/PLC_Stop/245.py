...
INFO = {
    'title':'PLC Stop,模糊 Command_code',
    'des':  'PLC Stop,模糊 Command_code',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Command_code=RandByte())
    template = Template(name='PLC Stop,模糊 Command_code', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
