...
INFO = {
    'title':'PLC Stop,模糊 Reserved',
    'des':  'PLC Stop,模糊 Reserved',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Reserved=RandByte(),Command_code=0x0402)
    template = Template(name='PLC Stop,模糊 Reserved', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
