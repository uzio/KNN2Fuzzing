...
INFO = {
    'title':'PLC Stop,模糊 Service_ID',
    'des':  'PLC Stop,模糊 Service_ID',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Service_ID=RandByte(),Command_code=0x0402)
    template = Template(name='PLC Stop,模糊 Service_ID', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
