...
INFO = {
    'title':'PLC Stop,模糊 Destination_network_address',
    'des':  'PLC Stop,模糊 Destination_network_address',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Destination_network_address=RandByte(),Command_code=0x0402)
    template = Template(name='PLC Stop,模糊 Destination_network_address', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
