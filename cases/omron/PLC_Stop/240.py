...
INFO = {
    'title':'PLC Stop,模糊 Source_node_number',
    'des':  'PLC Stop,模糊 Source_node_number',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Source_node_number=RandByte(),Command_code=0x0402)
    template = Template(name='PLC Stop,模糊 Source_node_number', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
