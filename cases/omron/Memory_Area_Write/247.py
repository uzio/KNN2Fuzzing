...
INFO = {
    'title':'Memory Area Write,模糊 Service_ID',
    'des':  'Memory Area Write,模糊 Service_ID',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Service_ID=RandByte(),Command_code=0x0102)/MemoryWriteCommand_Data()
    template = Template(name='Memory Area Write,模糊 Service_ID', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
