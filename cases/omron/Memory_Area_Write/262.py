...
INFO = {
    'title':'Memory Area Write,模糊 Beginning_Address_bits',
    'des':  'Memory Area Write,模糊 Beginning_Address_bits',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Command_code=0x0102)/MemoryWriteCommand_Data(Beginning_Address_bits=RandByte())
    template = Template(name='Memory Area Write,模糊 Beginning_Address', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
