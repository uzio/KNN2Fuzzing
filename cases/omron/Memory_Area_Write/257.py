...
INFO = {
    'title':'Memory Area Write,模糊 Number_of_items',
    'des':  'Memory Area Write,模糊 Number_of_items',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Command_code=0x0102)/MemoryWriteCommand_Data(Number_of_items=RandShort())
    template = Template(name='Memory Area Write,模糊 Number_of_items', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
