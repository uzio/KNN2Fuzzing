...
INFO = {
    'title':'Memory Area Write,模糊 Destination_node_address',
    'des':  'Memory Area Write,模糊 Destination_node_address',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Destination_node_address=RandByte(),Command_code=0x0102)/MemoryWriteCommand_Data()
    template = Template(name='Memory Area Write,模糊 Destination_node_address', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
