...
INFO = {
    'title':'Memory Area Write,模糊 Memory_Area_Code',
    'des':  'Memory Area Write,模糊 Memory_Area_Code',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Command_code=0x0102)/MemoryWriteCommand_Data(Memory_Area_Code=RandByte())
    template = Template(name='Memory Area Write,模糊 Source_node_number', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
