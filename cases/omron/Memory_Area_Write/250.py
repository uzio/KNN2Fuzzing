...
INFO = {
    'title':'Memory Area Write,模糊 Beginning_Address',
    'des':  'Memory Area Write,模糊 Beginning_Address',
    'id':   '2',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = OMRON_Header(Command_code=0x0102)/MemoryWriteCommand_Data(Beginning_Address=RandShort())
