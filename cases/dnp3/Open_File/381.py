...
INFO = {
    'title':'dnp3 open File时，模糊 Application_Control',
    'des':  'dnp3 open File时，模糊 Application_Control',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    template = Template(name='dnp3 open File时，模糊 Application_Control', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
