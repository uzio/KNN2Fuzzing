...
INFO = {
    'title':'dnp3 open File时，模糊FileDataObject中 FileOffset',
    'des':  'dnp3 open File时，模糊FileDataObject中 FileOffset',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = dnp3_ReadFileReq(FileDataObject=[dnp3_FileDataObject(FileOffset=RandShort())])
    template = Template(name='dnp3 open File时，模糊FileDataObject中 FileOffset', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
