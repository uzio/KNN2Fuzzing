...
INFO = {
    'title':'dnp3 open File时，模糊FileDataObject中 FileControlMode',
    'des':  'dnp3 open File时，模糊FileDataObject中 FileControlMode',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    template = Template(name='dnp3 open File时，模糊FileDataObject中 FileControlMode', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
