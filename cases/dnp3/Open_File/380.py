...
INFO = {
    'title':'dnp3 open File时，模糊FileDataObject中 FileRequestIdentifier',
    'des':  'dnp3 open File时，模糊FileDataObject中 FileRequestIdentifier',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = dnp3_ReadFileReq(FileDataObject=[dnp3_FileDataObject(FileRequestIdentifier=RandShort())])
    template = Template(name='dnp3 open File时，模糊FileDataObject中 FileRequestIdentifier', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
