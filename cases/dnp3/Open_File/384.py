...
INFO = {
    'title':'dnp3 open File时，模糊 Start_Bytes',
    'des':  'dnp3 open File时，模糊 Start_Bytes',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = dnp3_ReadFileReq(Start_Bytes=RandShort())
    template = Template(name='dnp3 open File时，模糊 Start_Bytes', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
