...
INFO = {
    'title':'dnp3 delete file时，模糊 Source',
    'des':  'dnp3 delete file时，模糊 Source',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = dnp3_DeleteFileReq(Source=RandShort())
    template = Template(name='dnp3 delete file时，模糊 Source', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
