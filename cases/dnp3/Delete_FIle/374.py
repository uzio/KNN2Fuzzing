...
INFO = {
    'title':'dnp3 delete file时，模糊 Destination',
    'des':  'dnp3 delete file时，模糊 Destination',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = dnp3_DeleteFileReq(Destination=RandShort())
    template = Template(name='dnp3 delete file时，模糊 Destination', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
