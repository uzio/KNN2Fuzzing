...
INFO = {
    'title':'dnp3 delete file时，模糊 FileDataObject 中 FileControlMode',
    'des':  'dnp3 delete file时，模糊 FileDataObject 中 FileControlMode',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = dnp3_DeleteFileReq(FileDataObject=[dnp3_FileDataObject(FileControlMode=RandShort())])
    template = Template(name='dnp3 delete file时，模糊 FileDataObject 中 FileControlMode', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
