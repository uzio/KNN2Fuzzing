...
INFO = {
    'title':'dnp3 delete file时，模糊 FileDataObject 中 QualiferField',
    'des':  'dnp3 delete file时，模糊 FileDataObject 中 QualiferField',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = dnp3_DeleteFileReq(FileDataObject=[dnp3_FileDataObject(QualiferField=RandByte())])
    template = Template(name='dnp3 delete file时，模糊 FileDataObject 中 QualiferField', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
