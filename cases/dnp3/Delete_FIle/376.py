...
INFO = {
    'title':'dnp3 delete file时，模糊 FileDataObject 中 FileOffset',
    'des':  'dnp3 delete file时，模糊 FileDataObject 中 FileOffset',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = dnp3_DeleteFileReq(FileDataObject=[dnp3_FileDataObject(FileOffset=RandShort())])
    template = Template(name='dnp3 delete file时，模糊 FileDataObject 中 FileOffset', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
