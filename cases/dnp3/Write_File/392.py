...
INFO = {
    'title':'dnp3 write File时，模糊 FileDataObject中的 FileOffset',
    'des':  'dnp3 write File时，模糊 FileDataObject中的 FileOffset',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = dnp3_WriteFileReq(FileDataObject=[dnp3_FileDataObject(FileOffset=RandShort())])
    template = Template(name='dnp3 write File时，模糊 FileDataObject中的 FileOffset', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
