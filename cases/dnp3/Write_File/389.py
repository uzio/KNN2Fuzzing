...
INFO = {
    'title':'dnp3 write File时，模糊 FileDataObject中的 FileRequestIdentifier',
    'des':  'dnp3 write File时，模糊 FileDataObject中的 FileRequestIdentifier',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = dnp3_WriteFileReq(FileDataObject=[dnp3_FileDataObject(FileRequestIdentifier=RandShort())])
    template = Template(name='dnp3 write File时，模糊 FileDataObject中的 FileRequestIdentifier', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
