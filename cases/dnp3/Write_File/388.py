...
INFO = {
    'title':'dnp3 write File时，模糊 Control',
    'des':  'dnp3 write File时，模糊 Control',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = dnp3_WriteFileReq(Control=RandByte())
    template = Template(name='dnp3 write File时，模糊 Control', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
