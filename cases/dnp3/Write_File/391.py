...
INFO = {
    'title':'dnp3 write File时，模糊 FileDataObject中的 FileControlMode',
    'des':  'dnp3 write File时，模糊 FileDataObject中的 FileControlMode',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = dnp3_WriteFileReq(FileDataObject=[dnp3_FileDataObject(FileControlMode=RandShort())])
    template = Template(name='dnp3 write File时，模糊 FileDataObject中的 FileControlMode', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
