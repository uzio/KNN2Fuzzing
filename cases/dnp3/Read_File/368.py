...
INFO = {
    'title':'dnp3 read File时，模糊 Application_Control',
    'des':  'dnp3 read File时，模糊 Application_Control',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    Packet = dnp3_ReadFileReq(Application_Control=RandByte())
    template = Template(name='dnp3 read File时，模糊 Application_Control', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
