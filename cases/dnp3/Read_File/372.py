...
INFO = {
    'title':'dnp3 read File时，模糊 FileDataObject 中的 QualiferField字段',
    'des':  'dnp3 read File时，模糊 FileDataObject 中的 QualiferField字段',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    template = Template(name='dnp3 read File时，模糊 FileDataObject 中的 QualiferField字段', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
