...
INFO = {
    'title': '获取EtherNet IP RegisterSession，模糊 status',
    'des':   '获取EtherNet IP RegisterSession，模糊 status',
    'id':   '1',
    'type': '1',
    'creator': 'lyp',
...
def fuzz(params):
    ...
    template = Template(name='获取EtherNet RegisterSession，模糊，模糊 status', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
