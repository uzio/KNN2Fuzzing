...
INFO = {
    'title': 'EtherNet IP SendRRData功能，模糊 options',
    'des':   '获取EtherNet IP SendRRData，模糊 options',
    'id':   '1',
    'type': '1',
    'creator': 'lyp',
...
def fuzz(params):
    Packet = ENIP_TCP(command_id=0x006f, options=RandInt())
    template = Template(name='获取EtherNet IP SendRRData，模糊 options', fields=[
        ScapyField(Packet,
                   name='template',
                   fuzzable=True,
                   seed=RANDSEED,
