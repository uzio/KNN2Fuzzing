...
INFO = {
    'title':'PLC Control时，模糊 Parameters 中的 ParameterBlockLength',
    'des':  'PLC Control时，模糊 Parameters 中的 ParameterBlockLength',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    READ_SZL_TEMPLATE = Template(name='PLC Control时，模糊 Parameters 中的 ParameterBlockLength', fields=[
