...
INFO = {
    'title':'Block download时，模糊 Parameters中的FunctionStatus字段',
    'des':  'Block download时，模糊 Parameters中的FunctionStatus字段',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    READ_SZL_TEMPLATE = Template(name='Block download时，模糊 Parameters中的FunctionStatus字段', fields=[
