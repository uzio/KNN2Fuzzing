...
INFO = {
    'title':'Data Read时，模糊 ROSCTR type ',
    'des':  'Data Read时，模糊 ROSCTR type ',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    READ_SZL_PACKET = TPKT() / COTPDT(EOT=1) / S7Header(ProtocolId=0x32,ROSCTR=RandByte(),
                                                        Parameters=S7ReadVarParameterReq(Items=S7ReadVarItemsReq()),
                                                        )

    READ_SZL_TEMPLATE = Template(name='Data Read时，模糊 ROSCTR type', fields=[
