...
INFO = {
    'title':'Data Read时，模糊 Parameter中的 ItemCount ',
    'des':  'Data Read时，模糊 Parameter中的 ItemCount ',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    READ_SZL_TEMPLATE = Template(name='Data Read时，模糊 Parameter中的 ItemCount ', fields=[
