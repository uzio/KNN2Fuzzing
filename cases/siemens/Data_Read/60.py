...
INFO = {
    'title':'Data Read时，模糊 Parameter中 Item部分AREAType',
    'des':  'Data Read时，模糊 Parameter中 Item部分AREAType',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    READ_SZL_TEMPLATE = Template(name='Data Read时，模糊 Parameter中 Item部分AREAType', fields=[
