...
INFO = {
    'title':'Data Read时，模糊 Parameter中 Item部分 Variable Specification',
    'des':  'Data Read时，模糊 Parameter中 Item部分 Variable Specification ',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    READ_SZL_TEMPLATE = Template(name='Data Read时，模糊 Parameter中 Item部分 Variable Specification ', fields=[
...
if __name__ == '__main__':
    ...
    params={'FUZZ_COUNT':2,
            'DELAY':1,
            'TARGET_IP':'10.150.217.199',  # 192.168.1.188
            'TIME_OUT':2,
            }
    fuzz(params)
