...
INFO = {
    'title':'Block Upload时，模糊 Parameters中的UploadID字段',
    'des':  'Block Upload时，模糊 Parameters中的UploadID字段',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    READ_SZL_TEMPLATE = Template(name='Block Upload时，模糊 Parameters中的UploadID字段', fields=[
