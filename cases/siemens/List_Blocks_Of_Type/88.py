...
INFO = {
    'title':'List bolcks of Type时，模糊 Data的 ReturnCode 字段',
    'des':  'List bolcks of Type时，模糊 Data的 ReturnCode 字段',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    READ_SZL_TEMPLATE = Template(name='List bolcks of Type时，模糊 Data的 ReturnCode 字段', fields=[
