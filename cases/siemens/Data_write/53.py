...
INFO = {
    'title': 'Data write时，模糊Parameter中Item count ',
    'des': 'Data write时，模糊Parameter中Item count ',
    'id': '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    READ_SZL_TEMPLATE = Template(name='Data write时，模糊Parameter中Item count', fields=[
