...
INFO = {
    'title': 'Data write时，模糊Parameter中Item中的ReturnCode',
    'des': 'Data write时，模糊Parameter中Item中的ReturnCode',
    'id': '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    READ_SZL_PACKET = TPKT() / COTPDT(EOT=1) / S7Header(ProtocolId=0x32, ROSCTR="Job",
                                                        ...
                                                        Data=S7WriteVarDataItemsReq(ReturnCode=RandByte())
                                                        )

    READ_SZL_TEMPLATE = Template(name='Data write时，模糊Parameter中Item中的ReturnCode', fields=[
