...
INFO = {
    'title':'Data write时，模糊  Redundancy Identification(Reserved)',
    'des':  'Data write时，模糊  Redundancy Identification(Reserved)',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    READ_SZL_PACKET = TPKT() / COTPDT(EOT=1) / S7Header(ProtocolId=0x32,ROSCTR="Job",
                                                        ...
                                                        Parameters=S7WriteVarParameterReq(Items=S7WriteVarItemsReq()),
