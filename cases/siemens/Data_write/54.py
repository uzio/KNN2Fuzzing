...
INFO = {
    'title': 'Data write时，模糊Parameter中Item中的Data',
    'des': 'Data write时，模糊Parameter中Item中的Data',
    'id': '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    READ_SZL_TEMPLATE = Template(name='Data write时，模糊Parameter中Item中的Data', fields=[
