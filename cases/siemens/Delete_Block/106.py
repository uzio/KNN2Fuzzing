...
INFO = {
    'title':'Delete Block时，模糊 Parameter中的 BlockNum',
    'des':  'Delete Block时，模糊 Parameter中的 BlockNum',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    READ_SZL_TEMPLATE = Template(name='Delete Block时，模糊 Parameter中的 BlockNum', fields=[
