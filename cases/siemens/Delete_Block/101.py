...
INFO = {
    'title':'Delete Block时，模糊 Parameter中的 BlockType',
    'des':  'Delete Block时，模糊 Parameter中的 BlockType',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    READ_SZL_TEMPLATE = Template(name='Delete Block时，模糊 Parameter中的 BlockType', fields=[
