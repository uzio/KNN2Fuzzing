...
INFO = {
    'title':'Read diag data时，模糊 ParameterLength',
    'des':  'Read diag data时，模糊 ParameterLength',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    READ_SZL_TEMPLATE = Template(name='Read diag data时，模糊 ParameterLength', fields=[
