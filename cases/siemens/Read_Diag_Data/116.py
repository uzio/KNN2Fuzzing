...
INFO = {
    'title':'Read diag data时，模糊 Parameter中的 DURN 字段',
    'des':  'Read diag data时，模糊 Parameter中的 DURN 字段',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    READ_SZL_TEMPLATE = Template(name='Read diag data时，模糊 Parameter中的 DURN 字段', fields=[
