...
INFO = {
    'title':'取系统状态列表，模糊 Data字段中的 Length ',
    'des':  '取系统状态列表，模糊 Data字段中的 Length ',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    READ_SZL_PACKET = TPKT() / COTPDT(EOT=1) / S7Header(ProtocolId=0x32,ROSCTR="UserData",
                                                        ...
                                                        Data=S7ReadSZLDataReq(Length=RandShort())
                                                        )

    READ_SZL_TEMPLATE = Template(name='取系统状态列表，模糊 Data字段中的 Length', fields=[
