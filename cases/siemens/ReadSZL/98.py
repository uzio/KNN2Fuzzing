...
INFO = {
    'title':'读取系统状态列表，模糊 Data字段中的 ReturnCode',
    'des':  '读取系统状态列表，模糊 Data字段中的 ReturnCode',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    READ_SZL_PACKET = TPKT() / COTPDT(EOT=1) / S7Header(ProtocolId=0x32,ROSCTR="UserData",
                                                        ...
                                                        Data=S7ReadSZLDataReq(ReturnCode=RandByte())
                                                        )

    READ_SZL_TEMPLATE = Template(name='读取系统状态列表，模糊 Data字段中的 ReturnCode', fields=[
