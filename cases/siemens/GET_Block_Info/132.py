...
INFO = {
    'title':'Get Block Info时，模糊 ParameterLength',
    'des':  'Get Block Info时，模糊 ParameterLength',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    READ_SZL_TEMPLATE = Template(name='Get Block Info时，模糊 ParameterLength', fields=[
