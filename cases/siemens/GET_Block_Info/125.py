...
INFO = {
    'title':'Get Block Info时，模糊 Data部分的 TransportSize',
    'des':  'Get Block Info时，模糊 Data部分的 TransportSize',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    READ_SZL_TEMPLATE = Template(name='Get Block Info时，模糊 Data部分的 TransportSize', fields=[
