...
INFO = {
    'title':'Data write时，模糊Parameter中Parameter Length ',
    'des':  'Data write时，模糊Parameter中Parameter Length ',
    'id':   '1',
    'type': '1',
    'creator': 'liuyongpan',
...
def fuzz(params):
    ...
    READ_SZL_TEMPLATE = Template(name='Data write时，模糊Parameter中Parameter Length', fields=[
